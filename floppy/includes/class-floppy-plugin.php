...
require_once FLOPPY_DIR . 'includes/class-floppy-rest-access.php';
require_once FLOPPY_DIR . 'includes/class-floppy-rest-arguments.php';
require_once FLOPPY_DIR . 'includes/class-floppy-rest-routes.php';
require_once FLOPPY_DIR . 'includes/class-floppy-rest-serializer.php';
require_once FLOPPY_DIR . 'includes/class-floppy-rest-streaming.php';
