...
The evidence report verifies the Xcode container, embedded File Provider extension, App Group entitlements, signing identity, notarization readiness, exported app signature, hardened runtime, and notarization ZIP contents. See `docs/release-evidence.md`.
